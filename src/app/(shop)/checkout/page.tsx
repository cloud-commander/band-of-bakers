    ...
    <div className={`min-h-screen ${DESIGN_TOKENS.sections.padding}`}>
      <div className="max-w-3xl mx-auto">
        ...
        <div className={`${DESIGN_TOKENS.cards.base} p-8 text-center`}>
          <h2 className={`${DESIGN_TOKENS.typography.h3.size} mb-4`}>Checkout Coming Soon</h2>
          <p className="text-muted-foreground mb-8">
            We are currently setting up our payment processor. In the meantime, please contact us
