...
import { updateNewsPost, getNewsPostById } from "@/actions/news";
...
export default function EditNewsPostPage({ params }: { params: { id: string } }) {
  ...
  const onSubmit = async (data: NewsPostForm) => {
    try {
      ...
      const result = await updateNewsPost(params.id, formData);
