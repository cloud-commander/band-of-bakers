...
export default function OrderDetailPage() {
  ...
  // Find the order
  const order = mockOrdersWithItems.find((o) => o.id === orderId);
  ...
  if (!order) {
    return (
      <div>
        <PageHeader title="Order Not Found" description="The requested order could not be found" />
        <div className="text-center py-12">
          <p className="text-muted-foreground mb-4">Order #{orderId} does not exist.</p>
          <Button asChild>
  ...
  // Get customer and bake sale info
  ...
  const handleSendEmail = () => {
    toast.success("Email sent to customer", {
      description: `Notification sent to ${customer?.email || "customer"}`,
    });
  };
                  ...
                  return (
                    ...
                    >
                      ...
                      <Button
                        ...
                        size="sm"
                        onClick={() =>
                          toggleItemAvailability(item.id, getProductName(item.product_id))
                        }
                        className={cn(
                          "ml-4",
                          isUnavailable
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              ...
              <div>
                ...
                <p className="text-sm">{bakeSale?.location?.name || "N/A"}</p>
              </div>
              <div>
